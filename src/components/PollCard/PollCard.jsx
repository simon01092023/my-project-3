...
export default function PollCard({ poll, isProfile, addVote, removeVote, loggedUser }) {
  ...
  // loggedUser has not liked the poll
     // - heart color - grey
  ...
  //   removeLike(poll.likes[voteIndex]._id) 
  // }
  ...
  const voteIndex = poll.votes.findIndex(vote => vote.username === loggedUser.username);
  ...
  return (
    ...
    <Card>
      ...
      <Image src={`${poll.photoUrl}`} wrapped ui={false} />
      <Card.Content>
